#' This function is an ensemble model that integrates three methods of cell2location, RCTD, and spatialDWLS using a linear weighted model.
#'
#' @param sc_data this is a seurat object, assay = "RNA"
#' @param st_data this is a seurat object, assay = "Spatial"
#' @param python_path this is python path
#'
#' @return This function returns the result of four methods of deconvolution, including cell2location, RCTD, spatialDWLS, and EnDecon.
#'
